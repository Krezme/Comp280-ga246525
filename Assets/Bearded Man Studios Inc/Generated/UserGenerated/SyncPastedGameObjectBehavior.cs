...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class SyncPastedGameObjectBehavior : NetworkBehavior
	{
		...
		public SyncPastedGameObjectNetworkObject networkObject = null;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (SyncPastedGameObjectNetworkObject)obj;
		...
		{
			Initialize(new SyncPastedGameObjectNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new SyncPastedGameObjectNetworkObject(networker, this, createCode, metadata);
		}
